...
public final class FXRouter {
    ...
    private static void loadNewRoute(RouteScene route) throws IOException {
        ...
        // Setting the data for the new scene's controller
        Object controller = loader.getController();
        if (controller instanceof DataReceivable) {  // Assuming DataReceivable is your interface with setData
            ((DataReceivable) controller).setData(route.data);
        }
